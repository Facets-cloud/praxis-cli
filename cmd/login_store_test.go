...
// driveInteractivePAT makes the interactive PAT tier land the given pair in the
// store, standing in for the browser deposit the real flow polls for. It
// verifies-and-persists directly (the deposit/poll mechanics are covered in
// login_pat_test.go); the browser tier is stubbed to fail the test.
